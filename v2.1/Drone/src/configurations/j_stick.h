...
bool jStickButtonChanged(void);

extern bool jdelta; //buttons or joysticks changed?

void jStickSendReport(void);

/*
* Joystick Report Format
*
* Identifier (A1,04)
* Throttle (not used)
* X1
...
#define JSTICK_RPT_BYTES 10
#define JSTICK_RPT_J_BYTES 4
#define JSTICK_RPT_B_BYTES 3

#define JSTICK_RPT_HEADER1 0xA1
#define JSTICK_RPT_HEADER2 0x04
#define JSTICK_RPT_THROTTLE 0
