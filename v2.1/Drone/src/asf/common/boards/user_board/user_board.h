...
#define B_PIN      IOPORT_CREATE_PIN(PORTF, 4)
...
#define JOYSTICK_L_CLICK IOPORT_CREATE_PIN(PORTD,5)
#define JOYSTICK_R_CLICK IOPORT_CREATE_PIN(PORTD,4)


// Joystick definitions:
#define JOYSTICK_L_X_PIN IOPORT_CREATE_PIN(PORTA, 6)
#define JOYSTICK_ADC_L_X ADCCH_POS_PIN6
#define JOYSTICK_L_Y_PIN IOPORT_CREATE_PIN(PORTB, 0)
#define JOYSTICK_ADC_L_Y ADCCH_POS_PIN8
#define JOYSTICK_R_X_PIN IOPORT_CREATE_PIN(PORTB, 6)
#define JOYSTICK_ADC_R_X ADCCH_POS_PIN14
#define JOYSTICK_R_Y_PIN IOPORT_CREATE_PIN(PORTB, 7)
#define JOYSTICK_ADC_R_Y ADCCH_POS_PIN15
...
// USB definitions:
#define USB_5V_PIN    IOPORT_CREATE_PIN(PORTB, 2)
