...
const struct ControllerConfiguration DRONE_KEYBOARD_CONFIG = {
	.mode = BTM_KEYBOARD,
	.button_configs = {
		{ // UP
			.config = {
	...
	.joystick_configs = {
		...
		{ // RIGHT JOYSTICK
			...
			.button_up = {
				.scan_code = 82 // Arrow key up
			},
			.button_down = {
				.scan_code = 81 // Arrow key down
			},
			.button_left = {
				.scan_code = 80 // Arrow key left
			},
			.button_right = {
				.scan_code = 79 // Arrow key right
			},
			.x_min = -1500, 
			.x_max = 1500,  
			.y_min = -1500, 
